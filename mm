getgenv().gagConfig = {
	...
	IGNORE_SUBMIT_EVENT_FORGE = { "Gem Egg", "Coal", "Grandmaster Sprinkler", "Master Sprinkler", "Godly Sprinkler", "Advanced Sprinkler", "Basic Sprinkler", "Trading Ticket", "Watering Can", "Levelup Lollipop", "Spooky Egg", "Jungle Egg", "Bug Egg", "Bee Egg", "Paradise Egg", "Zen Egg", "Safari Egg", "Rare Egg" }
    ...
    BUY_EGGS = { "Gem Egg", "Spooky Egg", "Jungle Egg", "Bug Egg", "Bee Egg", "Paradise Egg", "Zen Egg", "Safari Egg", "Rare Egg", ["Common Egg"] = 10 },
    PLANT_EGGS = { "Gem Egg", "Rare Egg" },
    ...
    USE_PETS_FOR_UPGRADE_SLOT = { "Glimmering Sprite", "Sunny-Side Chicken", "Spaghetti Sloth", "Chubby Chipmunk", "Ghost Bear", "Starfish" },
