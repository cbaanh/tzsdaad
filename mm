...
getgenv().gagConfig = {
    ...
    PLANT_EGGS = { "Bug Egg", "Paradise Egg", "Anti Bee Egg", "Enchanted Egg", "Gourmet Egg", "Corrupted Zen Egg", "Zen Egg", "Dinosaur Egg", "Primal Egg", "Night Egg", "Oasis Egg", "Sprout Egg"},
